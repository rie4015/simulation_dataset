...
physicsClient = p.connect(p.DIRECT)# запись видео , options='--mp4=moviename.mp4'
...
for i in range(steps):
    ...
    p_xforce = np.random.uniform(1500,10000,1)
    p_yforce = np.random.uniform(1500,10000,1)
    p_zforce = np.random.uniform(7000,15000,1)
